...
def main():
    ...
    parser.add_argument('--output_path', type=str, required=True, help='결과 CSV 파일 경로')
    ...
    for query_data in tqdm(queries, desc="쿼리 처리 중"):
        ...
        # 제출용 결과 생성 (사용자 ID는 eval_id를 사용)
        user_id = f"{eval_id:08d}-0000-0000-0000-000000000000"  # UUID 형식으로 변환
