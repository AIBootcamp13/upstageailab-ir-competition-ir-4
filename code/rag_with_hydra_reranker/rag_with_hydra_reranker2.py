...
def answer_question(messages, client, cfg, es, index_name, reranker_tokenizer=None, reranker_model=None, reranker_aux=None):
    # 함수 출력 초기화
...
def eval_rag(eval_filename, output_filename, client, cfg, es, index_name, reranker_tokenizer=None, reranker_model=None, reranker_aux=None):
    log = logging.getLogger(__name__)
    ...
    with open(eval_filename) as f, open(output_filename, "w") as of:
        ...
        for line in f:
            ...
            response = answer_question(j["msg"], client, cfg, es, index_name, reranker_tokenizer, reranker_model, reranker_aux)
...
def main(cfg: DictConfig) -> None:
    ...
    # Sentence Transformer 모델 초기화 (passage embedding)
    ...
    eval_rag(cfg.paths.eval_data, output_path, client, cfg, es, cfg.index.name, reranker_tokenizer, reranker_model, reranker_aux)
